...
async function exportLaporanToWord() {
    ...
    if (window.showLoading) {
        window.showLoading('Mengekspor ke Word...', 'Mengambil data dan foto...');
    }
    ...
    try {
        ...
        for (let i = 0; i < tableRows.length; i++) {
            ...
            // Update progress
            if (window.showLoading) {
                window.showLoading('Mengekspor ke Word...', `Memproses baris ${i + 1} dari ${tableRows.length}...`);
            }
        ...
        // Update progress
        if (window.showLoading) {
            window.showLoading('Mengekspor ke Word...', 'Membuat dokumen Word...');
        }
        ...
        if (window.showLoading) {
            window.showLoading('Mengekspor ke Word...', 'Mengunduh file...');
        }
